...
<div class="box box-success">
  <div class="box-header with-border">
    <h3 class="box-title">Inventario Sucursal</h3>
  </div>
  <div class="box-body">
      ...
      <form id="crear_inventario" class="form-numero">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="col-sm-1">
              <div class="form-group">
                <label>&nbsp;</label>
                <button type="button" id="btn_ver" class="btn btn-primary btn-as-block form-control"><i class="fa fa-search"></i></button>
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-1">
              <div class="form-group">
                <label>&nbsp;</label>
                <button type="button" id="btn_crear" class="btn btn-primary btn-as-block form-control"><i class="fa fa-save"></i></button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="col-sm-2 ">
              <div class="form-group">
                <button type="button" id="btn_listar" class="btn btn-primary btn-as-block"><i class="fa fa-list"></i> Ver Inventario</button>
              </div>
            </div>
          </div>                            
        </div>
...
@stop
@section('js')
  <script type="text/javascript" src="{{ asset('js/inventario_sucursal.js') }}"></script>
  @stack('js')
  @yield('js')
@stop
